...
function init(sliderName,sliderWidth,prev,next){
	...
	document.getElementById('slider_wrapper').style.width =li_width*3+35 + 'px';
	ul = document.getElementById(sliderName); 
	li_items = ul.children;
	imageNumber = li_items.length;
	for(i=0;i < imageNumber; i++){
	li_items[i].style.width =(li_width*3)+40+ 'px';
	}
	document.getElementById(sliderName).style.width =li_width*3*(imageNumber+1) + 'px';
	
	imageWidth = li_items[0].children[0].clientWidth -130;
...
var myElement2 = document.getElementById('swipe2');
